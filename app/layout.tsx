...
export const metadata: Metadata = {
  ...
  icons: [
    ...
    { rel: "icon", url: "/favicons/favicon-48x48.png", sizes: "48x48", type: "image/png" },
    { rel: "icon", url: "/favicons/favicon-72x72.png", sizes: "72x72", type: "image/png" },
    { rel: "icon", url: "/favicons/favicon-96x96.png", sizes: "96x96", type: "image/png" },
    { rel: "icon", url: "/favicons/android-icon-144x144.png", sizes: "144x144", type: "image/png" },
    { rel: "icon", url: "/favicons/android-icon-192x192.png", sizes: "192x192", type: "image/png" },
    { rel: "apple-touch-icon", url: "/favicons/apple-icon-57x57.png", sizes: "57x57" },
    { rel: "apple-touch-icon", url: "/favicons/apple-icon-60x60.png", sizes: "60x60" },
    { rel: "apple-touch-icon", url: "/favicons/apple-icon-72x72.png", sizes: "72x72" },
    { rel: "apple-touch-icon", url: "/favicons/apple-icon-76x76.png", sizes: "76x76" },
    { rel: "apple-touch-icon", url: "/favicons/apple-icon-114x114.png", sizes: "114x114" },
    { rel: "apple-touch-icon", url: "/favicons/apple-icon-120x120.png", sizes: "120x120" },
    { rel: "apple-touch-icon", url: "/favicons/apple-icon-144x144.png", sizes: "144x144" },
